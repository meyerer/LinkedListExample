...
**Author: Eric Meyer
**Date: 11 August 2019
**Description:  This is the implementation of the Quest1 Class.  Resources if any are listed
* below.
*****************************************************************************************/
...
int Quest1::askQuestion(int lives)
{
	//pointer to lives so validateAnswer can decrement it
	int* ptrLives = &lives;
	...
	do
	{
		...
		std::cout << "True or False: A target for clean is always required in a makefile" << std::endl;
...
/********************************************************************
* This function validates user input.  It recieves a pointer to an 
* int so lives can be decremented.  This is the same input from
* Game and the same input I have used throughout the course
********************************************************************/

bool Quest1::validateAnswer(int* ptrLives)
{
	//valid choice flag
